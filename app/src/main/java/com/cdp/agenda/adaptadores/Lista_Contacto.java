...
public class Lista_Contacto extends RecyclerView.Adapter<Lista_Contacto.ContactoViewHolder> {

    ArrayList<Contactos> listaContactos;
    ArrayList<Contactos> listaOriginal;

    public Lista_Contacto(ArrayList<Contactos> listaContactos) {
    ...
    public void onBindViewHolder(@NonNull ContactoViewHolder holder, int position) {
        ...
        holder.viewCorreo.setText(listaContactos.get(position).getNotas());
    }
    ...
    public class ContactoViewHolder extends RecyclerView.ViewHolder {
        ...
        public ContactoViewHolder(@NonNull View itemView) {
            ...
            viewCorreo = itemView.findViewById(R.id.viewNotas);
